...
export const LoadUser = (args) => async dispatch => {
...
export const LoginUser = ({email, password,value}) => async dispatch => {
    ...
    const body = JSON.stringify({email, password,value});
    try {
